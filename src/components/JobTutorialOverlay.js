...
const exampleMatches = [
  {
    id: '1',
    accepted: 1,
    lastMessage: "Can you come in for an interview?",
    otherUser: {
      name: "Alex Johnson",
...
const tutorialSteps = [
  {
    ...
    description: 'Let us show you how to find the perfect candidate for your business.',
    type: 'intro',
  ...
  },
  {
    ...
    description: 'You\'ll see candidate profiles like this that match your job requirements.',
    type: 'card',
  ...
  },
  {
    id: 3,
    title: 'Swipe Right',
    description: 'Swipe right on candidates you\'re interested in hiring.',
    type: 'swipe-right',
  ...
  },
  {
    id: 4,
    title: 'Swipe Left',
    description: 'Swipe left to pass on candidates that don\'t fit your needs.',
    type: 'swipe-left',
  ...
  },
  {
    id: 5,
    title: 'View Details',
    description: 'Tap on a card to see more information about the candidate.',
    type: 'tap-card',
    position: { top: SCREEN_HEIGHT * 0.15, left: SCREEN_WIDTH * 0.1 },
  ...
  },
  {
    id: 6,
    title: 'It\'s a Match!',
    description: 'When both you and the candidate are interested, you\'ll get a match notification.',
    type: 'match',
...
const JobTutorialOverlay = ({ onComplete }) => {
...
export default JobTutorialOverlay; 